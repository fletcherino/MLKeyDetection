...
if __name__ == '__main__':
    ...
    majlist = []
    minlist = []
    for folder in os.listdir(majdir):
        for subfolder in os.listdir(majdir + folder):
            print(majdir, folder, subfolder)
            if subfolder.endswith(".wav"):
                file_path = majdir + folder + "/" + subfolder
    ...
    for folder in os.listdir(mindir):
        for subfolder in os.listdir(mindir + folder):
            print(mindir, folder, subfolder)
            if subfolder.endswith(".wav"):
                file_path = mindir + folder + "/" + subfolder
                # file_path = 'untitled.wav'
                print('Open audio file path: ', file_path)
                print('')
                print('')
    ...
    with open("MajorVals.txt", "w") as output:
        output.writelines("%s\n" % maj for maj in majlist)
    with open("MinorVals.txt", "w") as output:
        output.writelines("%s\n" % min for min in minlist)
